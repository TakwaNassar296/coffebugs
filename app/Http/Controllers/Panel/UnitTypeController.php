...
class UnitTypeController extends Controller
{
    ...
    {
        return view('panel.pages.unit-types.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = [];
            $data = $request->only(['name_ar', 'name_en', 'contract_type','rooms']);
    ...
    {
        $unitTypes = UnitType::orderBy('id', 'desc')->get();
        ...
        return DataTables::of($unitTypes)
            ...
            ->addColumn('action', function ($item) {
                ...
                $data_attr .= 'data-contract_type="' . $item->rooms . '" ';

...
class DatabaseNotificationPolicy
{
     ...
     */
    public function view(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
     ...
     */
    public function update(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
     ...
     */
    public function delete(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
     ...
     */
    public function forceDelete(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
     ...
     */
    public function restore(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
     ...
     */
    public function replicate(Admin $admin, DatabaseNotification $databaseNotification): bool
    {
